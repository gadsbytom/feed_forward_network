...
from ann_feed_forward import feed_forward, CUST_feed_forward, sigmoid, tanh
import logging
import math
import numpy as np
import pandas as pd
...
def epoch(X, y, num_epochs, input_weights, output_weights, lr_o, lr_h, act):
    ...
    for i in range(num_epochs):
        ...
        hidden_output, ypred = CUST_feed_forward(X, input_weights, output_weights, act)

        input_weights, output_weights = CUST_backprop(
    ...
    return average_log_loss, num_epochs, input_weights, output_weights
