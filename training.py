...
def epoch_one(X, y, num_epochs, input_weights, hidden_weights, LR, lr_h, act):
    ...
    return average_log_loss, num_epochs, input_weights, hidden_weights



def epoch_two(X, y, num_epochs, input_weights, hidden_1_weights, hidden_2_weights, LR, lr_h, act):
    ...
    for i in range(num_epochs):
        ...
        input_weights, hidden_1_weights, hidden_2_weights = backprop_two_hidden(
